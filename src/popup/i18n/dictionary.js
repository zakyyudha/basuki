...
const dict = {
  ...
  field_from_hint:         { en: 'URL substring or pattern to match',                   id: 'URL atau pola yang dicocokkan' },
  field_to_hint:           { en: 'redirect destination URL',                            id: 'URL tujuan redirect' },
  field_pattern_hint:      { en: 'URL or regex match',                                  id: 'URL atau regex match' },
  ...
  field_ua_hint:           { en: 'Optional popup metadata',                              id: 'Metadata popup opsional' },
